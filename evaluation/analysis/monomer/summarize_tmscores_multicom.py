...
for file in os.listdir(base_path):
    ...
    try:
        ...
        if "Model" in df.columns and "TMscore" in df.columns:
            ...
            top1_tmscore = top1_row["TMscore"].values[0] if not top1_row.empty else None
            max_tmscore = filtered["TMscore"].max() if not filtered.empty else None
