...
cd /bmlfast/bml_casp16/tools/mindscience/MindSPONGE/applications/MEGAProtein/

export LD_LIBRARY_PATH=/bmlfast/bml_casp16/anaconda3/envs/megafold/lib/:$LD_LIBRARY_PATH
