...
from multicom_dev.common.protein import read_qa_txt_as_df, parse_fasta, complete_result, make_chain_id_map, get_stoichiometry_from_fasta
...
def main(argv):
    ...
    for fasta_file in os.listdir(FLAGS.fastadir):
        ...
        N6_outdir = outputdir + '/N6_multimer_structure_generation'
        ...
        run_methods_part1 = [# 'default_uniclust30',
                             ...
                             'string_interact_uniprot_sto', 'combine_v1', 'combine_v2']
        ...
        print("Complex multimer structure generation has been finished!")
        ...
        # N9_outdir = outputdir + '/N9_multimer_structure_evaluation_nodefault'
        # multimer_qa_result = run_multimer_evaluation_pipeline(fasta_path=FLAGS.fastadir + '/' + fasta_file,
        #                                                         params=params, monomer_model_dir="",
        #                                                         chain_id_map=chain_id_map,
        #                                                         indir=N6_outdir, outdir=N9_outdir,
