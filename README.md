...
- AlphaFold2-based predictors
     ...
     - Post-AlphaFold2-based predictors (requires models generated by default as inputs)
          ...
          | Predictor  | MSA | Template | monomer preset | dropout | dropout in structure module | Description |
          | -------- | ----- | ----- | ----- | ----- | ----- | ----- |
          | foldseek_refine | Default + Foldseek | Foldseek | monomer | false | true (0.1) | Foldseek refinement using the top-ranked models generated by default alphafold2, number of input models: 5; number of output models: 5 |
...
- AlphaFold-Multimer-based predictors
     ...
     | def_mul_af | default (uniprot) | default | alphafold2 predicted structure | false | true (0.1) | def_mul_af |
     ...
     | foldseek_iter | Foldseek-found paired alignments | input msa + Foldseek-found paired alignments | Foldseek-found templates | false | true (0.1) | Structural-alignment based methods |
     | foldseek_iter_nopair | None | input msa + Foldseek-found paired alignments | Foldseek-found templates | false | true (0.1) | Structural-alignment based methods |
     | foldseek_iter_notemp | Foldseek-found paired alignments | input msa + Foldseek-found paired alignments | no template | false | true (0.1) | Structural-alignment based methods |
